...
def runChatBot():
    ...
    while True:
        ...
        if choose is "1":
            ...
            second_chat = 'Chào Quý Khách, Quý khách muốn mua Laptop như thế nào ạ?'

        elif choose is "2":
            predict = tabletPredict
            second_chat = 'Chào Quý Khách, Quý khách muốn mua Máy Tính Bảng như thế nào ạ?'

        elif choose is "3":
            predict = mobilePredict
            second_chat = 'Chào Quý Khách, Quý khách muốn mua Điện Thoại Di Động như thế nào ạ?'
